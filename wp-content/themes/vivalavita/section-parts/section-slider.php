                            ...
                            while ($quality_construction_home_slider_section_query->have_posts()) {
                                ...
                                <div class="item <?php if ($i == 0) {
                                    ...
                                    <div class="carousel-caption">
                                        <h1 class="wow slideInLeft color-white clr_next"><?php the_title() ?></h1>
                                        <h3 class="wow slideInRight color-white clr_next"><?php echo esc_html( wp_trim_words(get_the_content(), 10) ); ?> </h3>
                                        <?php
                                        ...
                                        <a href="<?php the_permalink(); ?>" class="btn btn-seconday wow bounceInUp">
                                            <?php esc_html_e('подробнее', 'quality-construction'); ?>
                                        </a>
                                    </div>
