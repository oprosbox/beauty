...
if ( !function_exists('quality_construction_get_default_theme_options' ) ) :
    ...
    function quality_construction_get_default_theme_options()
    {
        ...
        $default['quality_construction_homepage_slider_option'] = 'скрыть';
        $default['quality_construction_slider_cat_id'] = 0;
        $default['quality_construction_no_of_slider'] = 3;
        $default['quality_construction_slider_get_started_txt'] = esc_html__('Начнем', 'quality-construction');
        $default['quality_construction_slider_view_more_txt'] = esc_html__('Подробнее', 'quality-construction');
        ...
        $default['quality_construction_top_header_section'] = 'скрыть';
        ...
        $default['quality_construction_blog_title_option'] = esc_html__('Блог', 'quality-construction');
        ...
        $default['quality_construction_read_more_text_blog_archive_option'] = esc_html__('Подробнее', 'quality-construction');

        // Details page.
        $default['quality_construction_show_feature_image_single_option'] = 'показать';
        ...
        $default['quality_construction_post_search_placeholder_option'] = esc_html__('Найти', 'quality-construction');
