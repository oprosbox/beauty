...
class Breadcrumb_Trail {
	...
	protected function set_labels() {
		...
		$defaults = array(
			...
			'aria_label'          => esc_attr_x( 'Меню', 'breadcrumbs aria label','quality-construction'),
			'home'                => esc_html__( 'Главная','quality-construction'),
			'error_404'           => esc_html__( '404 Not Found','quality-construction'),
			'archives'            => esc_html__( 'Архивы','quality-construction'),
			// Translators: %s is the search query. The HTML entities are opening and closing curly quotes.
			'search'              => esc_html__( 'Search results for &#8220;%s&#8221;','quality-construction'),
			// Translators: %s is the page number.
			'paged'               => esc_html__( 'Страница %s','quality-construction'),
			// Translators: Minute archive title. %s is the minute time format.
			'archive_minute'      => esc_html__( 'Минута %s','quality-construction'),
			// Translators: Weekly archive title. %s is the week date format.
			'archive_week'        => esc_html__( 'Неделя %s','quality-construction'),
